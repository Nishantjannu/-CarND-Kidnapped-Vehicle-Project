...
struct Particle {
  ...
  double theta;
  double weight;
  // the below variables are vectors (each element of the vector is at a given timestep)
  // ToDo: WHY are we tracking associations and measurements tho????
...
class ParticleFilter {  
 public:
  ...
  // standard way of initialising variables in a class
   ...
   *   standard deviation of y [m], standard deviation of yaw [rad]]
   // These deviations should be different from the GPS ones!!!!!!!
